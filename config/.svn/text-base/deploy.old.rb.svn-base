...
# OPTIONAL VARIABLES
# =============================================================================
 set :deploy_to, "/home/jobcorps/public_html/jobcorps" # defaults to "/u/apps/#{application}"
 set :user, "jobcorps"            # defaults to the currently logged in user
